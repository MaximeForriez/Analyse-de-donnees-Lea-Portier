...
#ce que j'ai rajouté permet de vérifier que le dossier en question, "diagramme" ou "histogrammes" n'existe pas, et auquel cas il n'existe pas le code le crée

try:
    os.makedirs("diagramme")
except:
    print("dossierdiagrammeexistant")
try:
    os.makedirs("histogrammes")
except:
    print("dossierhistogrammesexistant")
try:
    os.makedirs("graphes")
except:
    print("dossiergraphesexistant")
...
for index, row in contenu.iterrows():
    ...
    graphes = f"diagramme/diagramme_{nom_propre}.png"
    plt.savefig(graphes)
    plt.close()
